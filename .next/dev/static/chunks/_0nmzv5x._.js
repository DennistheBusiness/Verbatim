...
function CreatePage() {
    ...
    const { addSet } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$memorization$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemorization"])();
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CreatePage.useMemo[stats]": ()=>{
            ...
            const words = trimmed.split(/\s+/).filter({
                "CreatePage.useMemo[stats]": (w)=>w.length > 0
            }["CreatePage.useMemo[stats]"]).length;
            const paragraphs = trimmed.split(/\n\s*\n|\n/).map({
                "CreatePage.useMemo[stats]": (p)=>p.trim()
            }["CreatePage.useMemo[stats]"]).filter({
                "CreatePage.useMemo[stats]": (p)=>p.length > 0
            }["CreatePage.useMemo[stats]"]).length;
            return {
                words,
                paragraphs
...
_s(CreatePage, "+CrDaMzxorJOhAivrORPmGJPpkY=", false, function() {
    return [
...
//# sourceMappingURL=_0nmzv5x._.js.map