...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorLocalNotifications", path: "../../../node_modules/.pnpm/@capacitor+local-notifications@8.1.0_@capacitor+core@8.3.1/node_modules/@capacitor/local-notifications"),
        ...
        .package(name: "RevenuecatPurchasesCapacitor", path: "../../../node_modules/.pnpm/@revenuecat+purchases-capacitor@13.1.0_@capacitor+core@8.3.1/node_modules/@revenuecat/purchases-capacitor")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
